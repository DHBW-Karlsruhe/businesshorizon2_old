...
public class TimelinePresenter extends ScreenPresenter<TimelineViewInterface> {
        ...
        private void alles_neu() {
                ...
                if (stochastic) {
                        ...
                        addPastPeriods(projectProxy.getSelectedProject()
                                        .getRelevantPastPeriods() + weitere_perioden, projectProxy
        ...
        private void initalise() {
                ...
                if (stochastic) {
                        /**for (AbstractStochasticMethod method_stochastic : projectProxy
                                        .getSelectedProject().getStochasticMethod()) {*/
                                if (projectProxy
                                        .getSelectedProject().getStochasticMethod().getSelected()) {
                                        methode = projectProxy
                                                .getSelectedProject().getStochasticMethod().getName();
                ...
                if (deterministic) {
                        /**for (AbstractCalculationMethod method_deterministic : projectProxy
                                        .getSelectedProject().getCalculationMethod()) {*/
                                if (projectProxy
        ...
        private void addPastPeriods_vorhanden() {
                ...
                try {
                        ...
                        int extra_periode = 0;
                        if (methode == "Zeitreihenanalyse") {
                                // eine Periode mehr ausgeben als angegeben bei der
                                // Zeitreihenanalyse
                                extra_periode = 1;
                        }
