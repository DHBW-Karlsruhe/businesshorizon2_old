...
public class DirectCalculatedCashflowPeriod extends Period {
	...
	/**
	 * @param umsatzErlöseSet
	 *            the umsatzErlöseSet to set
	 */
	...
	/**
	 * @param umsatzKostenSet
	 *            the umsatzKostenSet to set
	 */
	...
	/**
	 * @param desinvestitionen
	 *            the desinvestitionen to set
	 */
	...
	/**
	 * @param desinvestitionenSet
	 *            the desinvestitionenSet to set
	 */
	...
	/**
	 * @param investitionenSet
	 *            the investitionenSet to set
	 */
	...
	public boolean isValid() {
		...
		if (UmsatzErlöse == null) {
			valid = false;
		}
		if (UmsatzKosten == null) {
			valid = false;
		}
		return valid;
	}
