...
public class IndirectCalculatedCashflowPeriod extends Period {
	...
	/**
	 * @param jahresÜberschussSet
	 *            the jahresÜberschussSet to set
	 */
	...
	/**
	 * @param jahresÜberschuss
	 *            the jahresÜberschuss to set
	 */
	...
	/**
	 * @param fiktiveSteuern
	 *            the fiktiveSteuern to set
	 */
	...
	/**
	 * @param fiktiveSteuernSet
	 *            the fiktiveSteuernSet to set
	 */
	...
	/**
	 * @param nichtZahlungswirksameAufwendungen
	 *            the nichtZahlungswirksameAufwendungen to set
	 */
	...
	/**
	 * @param nichtZahlungswirksameAufwendungenSet
	 *            the nichtZahlungswirksameAufwendungenSet to set
	 */
	...
	/**
	 * @param nichtZahlungswirksameErtraege
	 *            the nichtZahlungswirksameErtraege to set
	 */
	...
	/**
	 * @param nichtZahlungswirksameErtraegeSet
	 *            the nichtZahlungswirksameErtraegeSet to set
	 */
	...
	/**
	 * @param bruttoInvestitionen
	 *            the bruttoInvestitionen to set
	 */
	...
	/**
	 * @param bruttoInvestitionenSet
	 *            the bruttoInvestitionenSet to set
	 */
	...
	public boolean isValid() {
		...
		Double NichtZahlungswirksameAufwendungen = this
				.getNichtZahlungswirksameAufwendungen();
		Double NichtZahlungswirksameErtraege = this
				.getNichtZahlungswirksameErtraege();
		Double TaxShield = this.getTaxShield();
		Double Zinsaufwand = this.getZinsaufwand();
		if (BruttoInvestitionen == null) {
			valid = false;
		}
		...
		if (JahresÜberschuss == null) {
			valid = false;
		}
		if (NichtZahlungswirksameAufwendungen == null) {
			valid = false;
		}
		if (NichtZahlungswirksameErtraege == null) {
			valid = false;
		}
		if (TaxShield == null) {
			valid = false;
